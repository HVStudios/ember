...
export const emberMealsV1: Recipe[] = [
  {
    ...
    ingredientGroups: [
      { title: "Kyckling", ingredients: [i(700,"g","kycklinglårfilé eller kycklingbröst"),i(1.5,"msk","olivolja"),i(1,undefined,"lime","skal och juice"),i(2,"tsk","vitlökspasta"),i(1,"msk","chipotlepasta"),i(1.5,"tsk","spiskummin"),i(1.5,"tsk","rökt paprikapulver"),i(1,"tsk","oregano"),i(undefined,undefined,"salt och svartpeppar")] },
      ...
      { title: "Chipotle-limecrema", ingredients: [i(200,"g","grekisk yoghurt"),i(1,"msk","lättmajonnäs"),i(1,"tsk","chipotlepasta"),i(.5,undefined,"lime","juice"),i(1,"tsk","vitlökspasta"),i(undefined,undefined,"salt")] },
    ],
  ...
  },
  {
    ...
    ingredientGroups: [
      ...
      { title: "Sås", ingredients: [i(4,"msk","soja"),i(2,"msk","ostronsås"),i(2,"msk","gochujang"),i(1.5,"msk","honung"),i(1,"msk","ingefärspasta"),i(1,"msk","vitlökspasta"),i(1.5,"msk","risvinäger"),i(1.5,"tsk","sesamolja"),i(1,"dl","vatten"),i(2,"tsk","majsstärkelse")] },
  ...
  },
  {
    ...
    ingredientGroups: [
      ...
      { title: "Sås", ingredients: [i(1,undefined,"gul lök"),i(1,"msk","vitlökspasta"),i(1,"msk","ingefärspasta"),i(2,"msk","tomatpuré"),i(400,"g","krossade tomater"),i(2,"dl","lätt crème fraîche"),i(1,"dl","grekisk yoghurt"),i(1.5,"tsk","garam masala"),i(1,"tsk","spiskummin"),i(1,"tsk","paprikapulver"),i(.5,"tsk","gurkmeja"),i(undefined,undefined,"chiliflakes")] },
  ...
  },
  {
    ...
    ingredientGroups: [
      ...
      { title: "Sås", ingredients: [i(4,"msk","soja"),i(2,"msk","ostronsås"),i(2,"msk","hoisinsås"),i(2,"msk","honung"),i(1,"msk","vitlökspasta"),i(1,"msk","ingefärspasta"),i(1,"dl","vatten"),i(2,"tsk","majsstärkelse")] },
      { title: "Grönsaker", ingredients: [i(1,undefined,"broccoli"),i(2,undefined,"morötter"),i(2,undefined,"salladslökar"),i(undefined,undefined,"sesamfrön")] },
      { title: "Picklad gurka", ingredients: [i(1,undefined,"gurka"),i(1,"dl","risvinäger"),i(2,"msk","socker"),i(.5,"tsk","salt")] },
    ],
  ...
  },
  {
    ...
    ingredientGroups: [
      { title: "Kyckling", ingredients: [i(700,"g","kycklingbröst"),i(1,undefined,"citron","skal och juice"),i(2,"msk","olivolja"),i(1,"msk","vitlökspasta"),i(2,"tsk","oregano"),i(1,"tsk","timjan"),i(undefined,undefined,"salt och peppar")] },
      ...
      { title: "Tzatziki", ingredients: [i(300,"g","grekisk yoghurt"),i(.5,undefined,"gurka"),i(2,"tsk","vitlökspasta"),i(undefined,undefined,"citronjuice"),i(undefined,undefined,"dill"),i(undefined,undefined,"salt")] },
    ],
